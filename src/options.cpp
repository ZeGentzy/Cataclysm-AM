...
void options_manager::init()
{
...
#ifdef __ANDROID__
    add("ANDROID_SKIP_SPLASH", "android", translate_marker("Skip welcome screen"),
        translate_marker("If true, skips the Android welcome screen on app load."),
        false
        );
    ...
    add("ANDROID_KEYBOARD_SCREEN_SCALE", "android", translate_marker("Virtual keyboard screen scale"),
    ...
    add("ANDROID_SCREEN_ORIENTATION", "android", translate_marker("Screen orientation"),
        translate_marker("Use the device's sensor to orient the screen automatically, or force a specific orientation."),
        { { "slSensor", translate_marker("Sensor") },
          { "slPortrait", translate_marker("Portrait") },
          { "slLandscapeLeft", translate_marker("Landscape") },
          { "slLandscapeRight", translate_marker("Rev Landscape") } }, "slSensor", COPT_CURSES_HIDE
        );
#endif
    ...
    add("ANDROID_VIRTUAL_JOYSTICK_FOLLOW", "android", translate_marker("Virtual joystick follows finger"),
        translate_marker("If true, the virtual joystick will follow when sliding beyond its range."),
        true
        );

    add("ANDROID_REPEAT_DELAY_MAX", "android", translate_marker("Virtual joystick repeat rate (centered)"),
        translate_marker("When the virtual joystick is centered, how fast should input events repeat, in milliseconds."),
        50, 1000, 500
        );

    add("ANDROID_REPEAT_DELAY_MIN", "android", translate_marker("Virtual joystick repeat rate (deflected)"),
        translate_marker("When the virtual joystick is fully deflected, how fast should input events repeat, in milliseconds."),
        50, 1000, 100
        );

    add("ANDROID_SENSITIVITY_POWER", "android", translate_marker("Virtual joystick repeat rate sensitivity"),
    ...
    add("ANDROID_ACTIONMENU_AUTOADD", "android", translate_marker("Add shortcuts for action menu selections"),
        translate_marker("If true, automatically add a shortcut for actions selected via the in-game action menu."),
        true
        );

    add("ANDROID_INVENTORY_AUTOADD", "android", translate_marker("Add shortcuts for inventory selections"),
    ...
    add("ANDROID_2_SWIPE_DOWN_KEY", "android", translate_marker("Two-finger swipe down key (in-game)"),
        translate_marker("The key to press when swiping down with two fingers during gameplay."),
        "J", 1
        );

    add("ANDROID_2_SWIPE_LEFT_KEY", "android", translate_marker("Two-finger swipe left key (in-game)"),
        translate_marker("The key to press when swiping left with two fingers during gameplay."),
        "L", 1
        );

    add("ANDROID_2_SWIPE_RIGHT_KEY", "android", translate_marker("Two-finger swipe right key (in-game)"),
    ...
    add("ANDROID_SHORTCUT_AUTOADD", "android", translate_marker("Auto-manage contextual gameplay shortcuts"),
    ...
    add("ANDROID_SHORTCUT_AUTOADD_FRONT", "android", translate_marker("Move contextual gameplay shortcuts to front"),
    ...
    add("ANDROID_SHORTCUT_ZONE", "android", translate_marker("Separate shortcuts for No Auto Pickup zones"),
    ...
    add("ANDROID_SHORTCUT_REMOVE_TURNS", "android", translate_marker("Turns to remove unused gameplay shortcuts"),
    ...
    add("ANDROID_SHORTCUT_SCREEN_PERCENTAGE", "android", translate_marker("Shortcuts screen percentage"),
